...
using namespace System;
	...
	int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
	{
		...
		Window window = Window(STANDART_WINDOW_CLASSNAME, STANDART_WINDOW_NAME, L"Onyx Platform", true, center_x, center_y, STANDART_WIDTH_WITH_BORDER, STANDART_HEIGHT_WITH_BORDER, L"bin\\icon.ico");
		//Window window;
